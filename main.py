import pygame as pg
import sys
from classy.hadik import Hadik
from classy.hadik2 import Hadik2
from classy.jidlo import Jidlo
...
class Game:
    ...
    def new_game(self):
        self.snake = Hadik(self)
        self.snake2 = Hadik2(self)
        self.food = Jidlo(self)
